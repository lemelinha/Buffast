...
<main class="grid grid-rows-8 ml-16 h-screen">
    ...
    <div class=" grid grid-rows-subgrid row-span-8 justify-center justify-items-center p-8 font-bold md: md:p-8 lg: lg:p-8 lg:min-h-3.5">
        <button href="" class="row-start-8 bg-btn text-4xl h-16 p-2 rounded-full main-font text-amber-300 md:text-5xl lg:text-6xl lg:p-2">+Cadastrar</button>
    </div>
</main>
