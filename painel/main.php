<main class="ml-16">
    ...
    <aside class="pt-8 flex justify-end justify-items-center">
        ...
        <input type="text" class="bg-theme text-white font-bold rounded-full p-2 ml-4 mr-8 w-40 h-8 md:w-52 md:h-8 lg:w-52 lg:h-8 "></input>
    </aside>
    <div class="grid grid-cols-1 md:text-sm lg:text-base gap-12 md:grid-cols-3 md:gap-16 lg:grid-cols-4 p-8 lg:gap-12">
        <div class="bg-card rounded-lg shadow-2xl p-4">
                ...
                <section class="grid grid-cols-1 text-white font-bold p-2 text-xs md:text-sm lg:text-base">
        ...
        <div class="bg-card rounded-lg shadow-2xl p-4">
                <img src="../assets/queijo.jpg" class="rounded-lg shadow-2xl">
                 <section class="grid grid-cols-1 text-white font-bold p-2 text-xs md:text-sm lg:text-base">
                    <a href=".">Nome do Produto: Bolinha</a>
                    <a href=".">Quantidade no Pote: 5</a>
                    <a href=".">Descrição do Produto: Bolinha de Queijo</a>
                </section>
        </div>
        <div class="bg-card rounded-lg shadow-2xl p-4">
                <img src="../assets/pastel.jpg" class="rounded-lg shadow-2xl">
                 <section class="grid grid-cols-1 text-white font-bold p-2 text-xs md:text-sm lg:text-base">
                    <a href=".">Nome do Produto: Pastel</a>
                    <a href=".">Quantidade no Pote: 3</a>
                    <a href=".">Descrição do Produto: Pastel de Frango</a>
                </section>
        </div>
        <div class="bg-card rounded-lg shadow-2xl p-4">
                <img src="../assets/pastel.jpg" class="rounded-lg shadow-2xl bg-cover">
                 <section class="grid grid-cols-1 text-white font-bold p-2 text-xs md:text-sm lg:text-base">
                    <a href=".">Nome do Produto: Pastel</a>
                    <a href=".">Quantidade no Pote: 3</a>
                    <a href=".">Descrição do Produto: Pastel de Carne</a>
                </section>
        </div>
        <div class="bg-card rounded-lg shadow-2xl p-4">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoDeR4BcH8f1klSkGe46EDlwMn3AiJrs_vnw&s" class="rounded-lg shadow-2xl">
