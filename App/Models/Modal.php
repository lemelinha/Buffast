...
abstract class Modal {
    ...
    public static function Success(string $title, ?string $msg='', ?string $redirect=null): void {
        ...
        ?>
        <!-- Modal de Sucesso -->
        <div id='successModal' data-modal-backdrop="static" tabindex='-1' class='fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full'>
    ...
    public static function Error(string $title, ?string $msg='', ?string $redirect=null): void {
        ...
        ?>
        <!-- Modal de Erro -->
        <div id="errorModal" tabindex="-1" data-modal-backdrop="static" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="p-6 text-center">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const modalInstance = new Modal(modal, {
                    backdrop: 'static'  // Adicione esta opção
                });
                modalInstance.show();
            });
        </script>
